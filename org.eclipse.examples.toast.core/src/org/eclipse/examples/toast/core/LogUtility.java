...
public final class LogUtility extends Object {
	private static final String LOG_LEVEL_PROPERTY = "toast.logLevel"; //$NON-NLS-1$
	private static final String TRACE_PROPERTY = "toast.trace"; //$NON-NLS-1$
	private static final String LOG_LEVEL_ERROR_VALUE = "ERROR"; //$NON-NLS-1$
	private static final String LOG_LEVEL_WARNING_VALUE = "WARNING"; //$NON-NLS-1$
	private static final String LOG_LEVEL_INFO_VALUE = "INFO"; //$NON-NLS-1$
	private static final String LOG_LEVEL_DEBUG_VALUE = "DEBUG"; //$NON-NLS-1$
	...
	private static boolean TRACING = Boolean.valueOf(System.getProperty(LogUtility.TRACE_PROPERTY, LogUtility.DEFAULT_TRACE)).booleanValue();
	 ...
	 * 
	 * @param id An object that uniquely identifies the source of the message to
	 *        logged.
