 ...
 * @generated
 */
public class ToastBackEndDataSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IToastBackEndDataPackage.ADDRESS: {
				IAddress address = (IAddress)theEObject;
				T result = caseAddress(address);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IToastBackEndDataPackage.DRIVER: {
				IDriver driver = (IDriver)theEObject;
				T result = caseDriver(driver);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IToastBackEndDataPackage.PACKAGE: {
				IPackage package_ = (IPackage)theEObject;
				T result = casePackage(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IToastBackEndDataPackage.TRACKED_LOCATION: {
				ITrackedLocation trackedLocation = (ITrackedLocation)theEObject;
				T result = caseTrackedLocation(trackedLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IToastBackEndDataPackage.VEHICLE: {
				IVehicle vehicle = (IVehicle)theEObject;
				T result = caseVehicle(vehicle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IToastBackEndDataPackage.WAYBILL: {
				IWaybill waybill = (IWaybill)theEObject;
				T result = caseWaybill(waybill);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IToastBackEndDataPackage.HUB: {
				IHub hub = (IHub)theEObject;
	 ...
	 * @generated
	 */
	public T caseAddress(IAddress object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackage(IPackage object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tracked Location</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tracked Location</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTrackedLocation(ITrackedLocation object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseVehicle(IVehicle object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Waybill</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Waybill</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWaybill(IWaybill object) {
		return null;
	}
