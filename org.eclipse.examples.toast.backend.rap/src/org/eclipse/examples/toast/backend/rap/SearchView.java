...
public class SearchView extends ViewPart {
	...
	static final class VehicleLabelProvider extends CellLabelProvider {
		...
		private static Image CAR_IMAGE = Activator.getImageDescriptor("/icons/car-ok-16.png").createImage();
		private static Image CAR_PROBLEM_IMAGE = Activator.getImageDescriptor("/icons/car-minus-16.png").createImage();
